...
:start_with_python
start "Akito Story Import" /D "%~dp0" python tools\event_memory\story_import\web.py --data-dir data --host 127.0.0.1 --port %PORT%
goto open_browser

:start_with_py
start "Akito Story Import" /D "%~dp0" py -3 tools\event_memory\story_import\web.py --data-dir data --host 127.0.0.1 --port %PORT%
