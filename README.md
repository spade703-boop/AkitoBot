...
| `开启冒险补给` | 每周限 7 次：前 5 次各 140 积分，第 6 次 200、第 7 次 300；每次固定获得 30 经验和一件战备 |
...
- 只有完整符合 `发张+已有图库名或别名` 的群消息才会触发发图；未知分类、附加文字和空参数均静默处理
...
| `gallery_text.json` | 图库文案（存图回复 / 发图语气；旧版未知分类拒绝语字段不再使用） |
