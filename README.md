...
| `组队世界BOSS@某人` | 邀请 1 名已签到群友双人挑战世界 BOSS；成功则双方分别计算伤害并吃到小额协作伤害加成，失败则退化为发起人单打 |
...
| `我的角色` | 看等级/称号/战绩/普通装备状态/世界BOSS状态/积分/背包，战力为隐藏值不显示 |
...
- 世界 BOSS 只会在普通 `今日打怪` / `组队@某人` 后以 `0.1%` 概率出现；强度按近 7 日活跃签到人数生成，12 人后血量继续软扩容，但奖励扩容更慢；奖励只有经验和积分，不计入普通战绩
