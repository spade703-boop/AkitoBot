...
- 远征套装不与双倍经验卡叠成四倍，也不会消耗双倍经验卡；组队时每人的战备只影响自己的战力贡献、经验和掉落。两人都有护符且战斗失败时优先消耗发起人的一枚，额外 50% 经验只给护符持有者
- 冒险补给和付费送礼共用积分账本，不做硬路线锁定；`我的角色` 按 ISO 周跨群统计两边实际投入并显示软倾向。礼物券不计送礼投入，普通送礼按事件返还后的净消耗记录
