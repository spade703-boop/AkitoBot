...
DEFAULT_RPG_CONFIG: dict = {
    ...
    "copy": {
        ...
        "use_exp_buff_many": ["📖 【{name}】×{count} 已储备。普通挑战经验 ×{mult} 当前剩余 {uses} 场；常规战备生效期间会暂缓且不消耗。"],
        "use_exp_grant": ["📖 【{name}】用了。经验 +{amount}。"],
        "use_exp_grant_many": ["📖 【{name}】×{count} 已使用。经验 +{amount}。"],
        "supply_open": ["📦 冒险补给已开启。\n· 消耗 {cost} 积分（本周 {count}/{max}）\n· 获得【{name}】×1\n（效果：{effect}）\n· 经验 +{exp}，发送“{usage}”后生效{levelup}"],
        "supply_open_many": ["📦 冒险补给已开启 ×{draws}\n· 消耗 {cost} 积分（本周 {count}/{max}）\n{rewards}\n· 经验 +{exp}{levelup}"],
    ...
    "errors": {
        ...
        "item_batch_forbidden": "【{name}】不能一次使用多个，请逐个使用。",
        "supply_limit": "这周已经开过 {max} 次冒险补给了，下周再来。",
        "supply_poor": "积分不够。第 {count} 次冒险补给需要 {cost} 积分，你现在只有 {total}。",
        "supply_batch_poor": "积分不够。一次开启 {count} 次冒险补给需要 {cost} 积分，你现在只有 {total}。本次没有开启任何补给。",
        "supply_remaining": "本周还可以开启 {remaining} 次冒险补给，不能一次开启 {count} 次。",
