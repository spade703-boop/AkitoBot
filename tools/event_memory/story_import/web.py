    ...
    def coverage_payload(self, filters: dict[str, str] | None = None) -> dict[str, Any]:
        return {
            ...
            "options": {
                ...
                "timeline_stage_descriptions": TIMELINE_STAGE_DESCRIPTIONS,
                "event_types": EVENT_TYPES,
                "participant_scopes": PARTICIPANT_SCOPES,
                "participant_scope_label": PARTICIPANT_SCOPE_LABEL,
                "participant_scope_descriptions": PARTICIPANT_SCOPE_DESCRIPTIONS,
