...
import nonebot_plugin_akito.features.rpg.equipment.smith as smith
import nonebot_plugin_akito.features.rpg.player.player as player
...
def test_rebuy_equip_success(monkeypatch):
    from nonebot_plugin_akito.features.rpg.equipment import smith as _s
    cf = {
        "equip": {
            "base": 10,
            "per_level": 5,
